...
from detector.modeler import NaiveBayesFraudModel
...
def parse_args():
    parser = argparse.ArgumentParser(description="Naive Bayes Model Fraud Detector Pipeline")
...
def train_model(train_data, hyper_params, use_aug=False):
    ...
    model = NaiveBayesFraudModel(**hyper_params)
